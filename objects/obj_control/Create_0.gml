...
for (var i=0; i<30; i++) {
	var alp = (i mod 2)!=0
	vertex_position(global.h_buff, i, 0)
	vertex_color(global.h_buff, c_white, alp)
	vertex_position(global.h_buff, i, 1)
	vertex_color(global.h_buff, c_white, alp)
	
	vertex_position(global.h_buff, i, 0)
	vertex_color(global.h_buff, c_white, 1-alp)
	vertex_position(global.h_buff, i, 1)
	vertex_color(global.h_buff, c_white, 1-alp)
...
instance_create_depth(0,0,-10,obj_hairs);
...
[ //волосы
	[ //слои
		...
		[ //массивы точек ограниченой длинны
			//[x,y],[x,y],[x,y],[x,y],[x,y] //точки
			[x,x,x,x,x,x,x],
			[y,y,y,y,y,y,y,]
		], 
		[
